...
| Struct | Finalidade |
|---|---|
| `Usuario` | Dados de login e perfil de acesso |
| `Cadastro` | Contratos de aluguel e vendas de impressoras |
| `Chamado` | Registros de manutenção técnica |
| `Garantia` | Solicitações de garantia |
| `Produtos` | Vendas de peças e insumos |
